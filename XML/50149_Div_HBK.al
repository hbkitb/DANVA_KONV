        ...
        if svar = 1 then begin
            ...
            IF GenPostSetup.FINDSET THEN
                REPEAT
                    ...
                    GenPostSetup."Inventory Adjmt. Account" := '011998';  //Felt07;
                    GenPostSetup."Direct Cost Applied Account" := '011998';  //modkonto køb
                    GenPostSetup."Overhead Applied Account" := '011998';     //modkonto køb

                    GenPostSetup."Purchase Variance Account" := '011998';    //Købsafvigelse
                    GenPostSetup.MODIFY;
        ...
        if svar = 2 then begin
            ...
            IF GenvareSetup.FINDSET THEN
                REPEAT
                    ...
                    //hIF STRLEN(Felt02) = 5 THEN
                    //141220 GenPostSetup."Sales Account" := Felt02;
                    GenvareSetup."Inventory Account" := '011998'; //Felt06; //Felt03;  //'13800';
                    GenVareSetup."Inventory Account (Interim)" := '011998'; //Felt06;
                                                                            //hIF STRLEN(Felt09) = 4 THEN
        ...
        if svar = 1 then begin
            ...
            IF CustPost.FINDSET THEN
                REPEAT
                    ...
                    CustPost."Payment Disc. Debit Acc." := '011998'; //Felt04;
                    CustPost."Payment Disc. Credit Acc." := '011998'; //Felt04;

                    CustPost."Interest Account" := '007050';
                    CustPost."Additional Fee Account" := '006011';

                    CustPost."Invoice Rounding Account" := '007250';
                    CustPost."Debit Curr. Appln. Rndg. Acc." := '007250';
                    CustPost."Credit Curr. Appln. Rndg. Acc." := '007250';
                    CustPost."Debit Rounding Account" := '007250';
                    CustPost."Credit Rounding Account" := '007250';
                    CustPost."Payment Tolerance Debit Acc." := '007230';
                    CustPost."Payment Tolerance Credit Acc." := '007230';
