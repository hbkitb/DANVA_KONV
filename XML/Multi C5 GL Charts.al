        ...
        textelement(Import_GLChart)
        {
            ...
            tableelement(GLAccount; "G/L Account")
            {
                ...
                textelement(MandPurpose)
                {
                    ...
                    begin
                        If (Purpose <> '') or (MandPurpose = '1') then
                ...
                fieldelement(GenProdPostongGrp; GLAccount."Gen. Prod. Posting Group")
                {
                    ...
                    begin
                        ...
                        */
                        ...
                        if ((GLAccount."Gen. Prod. Posting Group" = 'DIV')) then begin
                            GLAccount."Gen. Posting Type" := GLAccount."Gen. Posting Type"::Purchase;
                            GLAccount."Gen. Bus. Posting Group" := 'INDENLANDS';
                            GLAccount."Gen. Prod. Posting Group" := 'DIV';
                            GLAccount."VAT Bus. Posting Group" := 'INDENLANDS'; //'INDLAND';
                            GLAccount."VAT Prod. Posting Group" := 'STANDARD';
                            //FinKart.Modify();
                        end;
                    end;
                }
