        ...
        textelement(Import_GLOpening)
        {
            ...
            tableelement(GenJournalLine; "Gen. Journal Line")
            {
                ...
                begin
                    ...
                    //240621 GenJournalLine.Validate(GenJournalLine."Gen. Prod. Posting Group", '');
                    GenJournalLine."Gen. Prod. Posting Group" := '';  //240621
                    GenJournalLine."VAT Bus. Posting Group" := '';  //240621
                    GenJournalLine."VAT Prod. Posting Group" := ''; //240621
